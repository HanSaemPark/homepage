  ...
  <div id="menu-push">
    <div class="box">
      ...
      <div class="content">
        ...
        <h5>TRAVEL</h5>
        <ul>
          <li><a href="\BLOG\ATF\map1.jsp"><i class="fa fa-image"></i>제주도 여행</a></li>
          <li><a href="\BLOG\ATF\map2.jsp"><i class="fa fa-image"></i>강원도 강릉 여행</a></li>
          <li><a href="\BLOG\ATF\map3.jsp"><i class="fa fa-image"></i>전라도 군산 여행</a></li>
          <li><a href="\BLOG\ATF\map6.jsp"><i class="fa fa-image"></i>한겨울의 피난</a></li>
        </ul></div>
        ...
        <h5>EATING</h5>
        <ul>                               <!-- fa fa-lock-->
          <li><a href="\BLOG\ATF\map4.jsp"><i class="fa fa-image"></i>전라도 여행</a></li>
          <li><a href="\BLOG\ATF\map5.jsp"><i class="fa fa-image"></i>대만 타이페이 여행</a></li>
        ...
        <h5>매일매일</h5>
        <ul>
          <li><a href="\BLOG\ATF\map7.html"><i class="fa fa-newspaper-o"></i>다같이 맛점!!</a></li>
          <li><a href="\BLOG\ATF\map8.html"><i class="fa fa-newspaper-o"></i>술안주엔 이게 딱!!</a></li>
          <li><a href="\BLOG\ATF\map9.html"><i class="fa fa-newspaper-o"></i>점심도시락</a></li>
...
<body>
	...
	<div class="max-width">
        ...
        <p></p></div> -->
			<div class="item">
				<img src="food1\f1.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f2.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f3.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f4.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f5.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f6.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f7.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f8.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f9.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f10.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f11.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f12.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f13.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f14.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f15.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f16.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f17.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f18.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food1\f19.jpg" width="640" height="480" alt="" />
			</div>
		</div>
	</div>
	<script type="text/javascript">
