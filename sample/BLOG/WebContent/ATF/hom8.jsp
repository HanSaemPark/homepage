  ...
  <div id="menu-push">
    <div class="box">
      ...
      <div class="content">
        ...
        <h5>TRAVEL</h5>
        <ul>
          <li><a href="\BLOG\메인여행\map1.jsp"><i class="fa fa-image"></i>제주도 여행</a></li>
          <li><a href="\BLOG\메인여행\map2.jsp"><i class="fa fa-image"></i>강원도 강릉 여행</a></li>
          <li><a href="\BLOG\메인여행\map3.jsp"><i class="fa fa-image"></i>전라도 군산 여행</a></li>
          <li><a href="\BLOG\메인여행\map6.jsp"><i class="fa fa-image"></i>한겨울의 피난</a></li>
        </ul></div>
        ...
        <h5>EATING</h5>
        <ul>                               <!-- fa fa-lock-->
          <li><a href="\BLOG\메인여행\map4.jsp"><i class="fa fa-image"></i>전라도 여행</a></li>
          <li><a href="\BLOG\메인여행\map5.jsp"><i class="fa fa-image"></i>대만 타이페이 여행</a></li>
        ...
        <h5>매일매일</h5>
        <ul>
          <li><a href="\BLOG\메인요리\map7.html"><i class="fa fa-newspaper-o"></i>다같이 맛점!!</a></li>
          <li><a href="\BLOG\메인요리\map8.html"><i class="fa fa-newspaper-o"></i>술안주엔 이게 딱!!</a></li>
          <li><a href="\BLOG\메인요리\map9.html"><i class="fa fa-newspaper-o"></i>점심도시락</a></li>
...
<body>
	...
	<div class="max-width">
        ...
        <p></p></div> -->
			<div class="item">
				<img src="food2\p1.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p2.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p3.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p4.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p5.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p6.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p7.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p8.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p9.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p10.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p11.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p12.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p13.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p14.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p15.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p16.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p17.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p18.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p19.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p20.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p21.jpg" width="640" height="480" alt="" />
			</div>
			<div class="item">
				<img src="food2\p22.jpg" width="640" height="480" alt="" />
			</div>
		</div>
	</div>
	<script type="text/javascript">
