...
<body>
	...
	<div id="menu-push">
		<div class="box">
			...
			<div class="content">
				...
				<a href="/블로그/main.jsp"><h5>메인화면</h5></a>

				<ul>
					<li><a href="first\info.jsp" class="btn btn-warning btn-block"><i
							class="fa fa-newspaper-o"></i>회원정보</a></li>
					<li><a href="board\board.jsp"
						class="btn btn-warning btn-block"><i class="fa fa-newspaper-o"></i>게시판</a></li>
					<li><a href="chat\chat.jsp" class="btn btn-info btn-block"><i
							class="fa fa-newspaper-o"></i>CHATBOT</a></li>
					<li><a href="first\logoutAction.jsp"
	...
	<div class="intro">
		<img src="image2/bike2.jpg" alt="" / width="700" height="800">
	...
	<div class="box">
		<img src="image/1-1.jpg" alt="" / width="950" height="500">
	</div>
	...
	<div class="box">
		<img src="image/1-2-1.jpg" alt="" / width="950" height="500">
	</div>
	</article> <article>
	<div class="box">
		<div class="feed">
	...
	<div class="box">
		<img src="image/1-2.jpg" alt="" / width="950" height="500">
	</div>
	</article> <article>
	<div class="box">
		<div class="feed">
	...
	<div class="box">
		<img src="image/food.jpg" alt="" / width="950" height="500">
	</div>
	</article> <article>
	<div class="box">
		<div class="feed">
	...
	<div class="box">
		<img src="image/1-4.jpg" alt="" / width="950" height="500">
	</div>
	</article>
