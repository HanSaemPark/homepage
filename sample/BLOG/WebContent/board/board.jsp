...
<body>
		...
		<div class="box">
			...
			<div class="content">
				...
				<ul>
					...
					<li><a href="\BLOG\chat\chat.jsp" class="btn btn-info btn-block"><i
				...
				<h5></h5>
				<img src="image/홍도1.png" alt="" /> <img src="image/홍도2.png" alt="" />
				<img src="image/홍도3.png" alt="" /> <img src="image/홍도4.png" alt="" />
               ...
               <ul>
                  <li><a href="\BLOG\메인여행\hom1.jsp"><i class="fa fa-image"></i>제주도
                        여행</a></li>
                  <li><a href="\BLOG\메인여행\hom2.jsp"><i class="fa fa-image"></i>강원도
                        강릉 여행</a></li>
                  <li><a href="\BLOG\메인여행\hom3.jsp"><i class="fa fa-image"></i>전라도
                        군산 여행</a></li>
                  <li><a href="\BLOG\메인여행\hom6.jsp"><i class="fa fa-image"></i>한겨울의
                        피난</a></li>
               </ul>
            </div>
            ...
            <div style="overflow-y: scroll; height: 40px;">
               ...
               <ul>
                  <!-- fa fa-lock-->
                  <li><a href="\BLOG\메인여행\hom4.jsp"><i class="fa fa-image"></i>전라도
                        여행</a></li>
                  <li><a href="\BLOG\메인여행\hom5.jsp"><i class="fa fa-image"></i>대만
                        타이페이 여행</a></li>
            ...
            <div style="overflow-y: scroll; height: 40px;">
               ...
               <ul>
                  <li><a href="\BLOG\메인요리\map7.html"><i class="fa fa-newspaper-o"></i>다같이
                        맛점!!</a></li>
                  <li><a href="\BLOG\메인요리\map8.html"><i class="fa fa-newspaper-o"></i>술안주엔
                        이게 딱!!</a></li>
	...
	<!-- <div id="realtime" class="container">
		<div class="list-group">
			<a href="#" class="list-group-item list-group-item-action">1번 게시물</a>
			<a href="#" class="list-group-item list-group-item-action">2번 게시물</a>
			<a href="#" class="list-group-item list-group-item-action">3번 게시물</a>
		</div>
	</div>
	<br> -->
	...
	<div class="container">
		<div class="row">
			<!-- 12개의 칼럼 -->
			<div class="col-lg-2">
         		<img src ="image/블1.png" height="450">
           </div>
			<div class="col-lg-8">
				<table class="table table-striped" style="border: 1px solid #dddddd">
					...
					<tbody>
						...
						<%
							//board테이블에 있는 데이터를 뿌려야함
							BlogBoardDAO blogboardDAO = new BlogBoardDAO();
							ArrayList<BlogBoard> list = null;
							if (search == null) {
								list = blogboardDAO.getList(pageNum);
							} else {
								list = blogboardDAO.search(search);
							}

							for (BlogBoard b : list) {
						%>
						<tr>
							<td><%=b.getBdID()%></td>

							<td><a href="/BLOG/board/view.jsp?bdID=<%=b.getBdID()%>">
				...
				<a class="btn btn-warning"
					href="/BLOG/board/board.jsp?pageNum=<%=pageNum - 1%>"
					style="margin: 2px">이전</a>

				<%
					}
					if (blogboardDAO.nextPage(pageNum + 1)) {
				%>
				<a class="btn btn-warning"
					href="/BLOG/board/board.jsp?pageNum=<%=pageNum + 1%>"
				...
				<a class="btn btn-danger float-right" href="/BLOG/board/write.jsp"
			...
			<div class="col-lg-2">
				...
				<!-- search -->
				<form method="GET" action="/BLOG/board/board.jsp" name="srch">

					<SELECT name='col'>
						<!-- 검색 컬럼 -->
						<OPTION value='none'>전체 검색</OPTION>
						<OPTION value='rname'>게시글 사용자</OPTION>
						<OPTION value='title'>게시글 제목</OPTION>
						<OPTION value='title'>게시글 번호</OPTION>
