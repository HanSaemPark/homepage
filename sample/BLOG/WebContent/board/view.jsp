...
<body>
   ...
   <%
      ...
      if (session.getAttribute("userEmail") != null) {
         if(session.getAttribute("userEmail").equals("melomelo11@naver.com")){
            
            admin = (String) session.getAttribute("userEmail");
      ...
      BlogBoard blogboard = blogboardDAO.getBlogBoard(bdID);
   %>
   ...
   <div id="menu-push">
      <div class="box">
         <div class="profile">
            <img src="image/fork.jpg" alt="" /><span><a href="/BLOG/main.jsp">쿰척쿰척</a></span>
         </div>
         <div class="content">
...
<!-- ------------------------------------------------------------------------------------------------------ -->
   ...
   <div class="container">
      <div class="row">
         ...
         <img src ="image/블4.PNG" height="550">
		...
		<div id="realtime" class="container">
			<div class="list-group">
				<a href="#" class="#"><h4 style="text-align:center">최근게시물보기</h4></a>
				<a href="#" class="list-group-item list-group-item-action" style="text-align:center">1번 게시물</a>
				<a href="#" class="list-group-item list-group-item-action" style="text-align:center">2번 게시물</a>
				<a href="#" class="list-group-item list-group-item-action" style="text-align:center">3번 게시물</a>
			</div>
		</div><br>
			...
			<table class="table table-striped" style="border: 1px solid #dddddd">
               <thead>
                  <tr>
                     <th colspan="3">게시판 글을 봅시댜 ◟꒰◍´Д‵◍꒱◞</th>
                  </tr>
               </thead>
               <tbody>
                  <tr>
                     <td>➀글제목</td>
                     <td colspan="2"><%=blogboard.getBdTitle()%></td>
                     
                  </tr>
                  <tr>
                  
                     <td>➁작성자</td>
                     <td colspan="2"><%=blogboard.getUserEmail()%></td>
                  ...
                  <tr>
                     ...
                     <td>➂작성일자</td>
                     <td colspan="2"><%=blogboard.getBdDate()%></td>
                     
                  </tr>
                  <tr>
                  
                     <td>➃글내용</td>
                     <td colspan="2"><%=blogboard.getBdContent()%></td>
            ...
            <a href="/BLOG/board/board.jsp" class="btn btn-success"
               style="margin: 2px">목록</a>
            <!-- 글쓴이만 수정 버튼이 필요함 -->

            <%
               if ((userEmail != null && userEmail.equals(blogboard.getUserEmail())) || admin != null) {
            %>

            <a class="btn btn-warning"
               href="/BLOG/board/update.jsp?bdID=<%=bdID %>">수정</a> 
               
            <a class="btn btn-danger"
               href="/BLOG/board/deleteAction.jsp?bdID=<%=bdID %>">삭제</a>
         ...
         <img src ="image/블5.PNG" height="550">
   ...
   <script type="text/javascript">
    ...
    <script>
		...
		function getAjaxList(){
			...
			// 여기에 key, value 값을 넣을수 있음.
			$.ajax({
				type:"GET", // 호출방식
				url:"ABoardList", // 사용할 주소
				// 데이터타입 ArrayList를 못보내서 json타입으로 통일 시킴.
				dataType:"json", 
				//이게 JSONObject임
				success:function(data){
		            ...
		            list[0].innerHTML = "<a href='/BLOG/board/view.jsp?bdID="+data[0].bdID+"'>"+data[0].bdTitle+"</a>";
		            list[1].innerHTML = "<a href='/BLOG/board/view.jsp?bdID="+data[1].bdID+"'>"+data[1].bdTitle+"</a>";
		            list[2].innerHTML = "<a href='/BLOG/board/view.jsp?bdID="+data[2].bdID+"'>"+data[2].bdTitle+"</a>";
				}
				
			});  
		}
		
		setInterval(getAjaxList, 5000); //5000은 5초를 의미.
