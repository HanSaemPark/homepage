...
<body>
	...
	<div class="container">
		<div class="row">
         ...
         <img src ="image/블6.PNG" height="450">
         
         </div>
			<div class="col-lg-8">
				<form action="/BLOG/board/updateAction.jsp" method="post">
					...
					<tr>
						<td>
							...
							value="<%=blogboard.getBdTitle() %>" name="bdTitle" maxlength="50">
						</td>
					</tr>
					<tr>
						<td>
							<textarea class="form-control"  
							name="bdContent" maxlength="2048" style="height:350px;">
							
							<%=blogboard.getBdContent() %>
         ...
         <img src ="image/블7.PNG" height="450">
